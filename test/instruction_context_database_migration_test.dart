...
void main() {
  ...
  test(
    'v4 → v6 migration program satırını korur ve çakışmayı akademik yıl bazına taşır',
    () async {
      ...
      final versionRows = await migrated.database.rawQuery(
        'PRAGMA user_version',
      );
      ...
      expect(
        await migrated.database.query('lesson_schedule_slots'),
        hasLength(2),
      );
